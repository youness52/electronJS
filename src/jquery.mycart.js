...
(function ($) {
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '<input type="hidden" name="itemname[]" value="' +this.name +'" />'+' </td>' + 
          '<th title="Unit Price">' + this.price + '<input type="hidden" name="allprices[]" value="' +this.price +'" />' + '</th>' + 
          '<td title="Quantity"><input type="number" name="qt[]" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '" readonly/></td>' +
          '<th title="Total" class="' + classProductTotal + '">' + total + '</th>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '"></strong>' + '<input type="hidden" id="totalpricescmd" name="totalpricescmd" value="" />' + '</td>' + 
        '<td></td>' +
        '</tr>'
        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">Ajouter des articles</div>'
      );
    ...
    var showGrandTotal = function(){
      ...
      $("#totalpricescmd").val("" + ProductManager.getTotalPrice());
